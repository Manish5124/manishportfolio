  ...
  return (
    <div className="about">
      ...
      <p className="text-secondary story-content data">
        {`Hello, I'm Manish Chouhan, a dedicated full-stack web developer with a penchant for crafting robust digital solutions. With a fervent passion for coding, I immerse myself in the dynamic realms of Java for backend development and harness the power of React for front-end mastery.
`}
        <br />
        <br />
        {`
